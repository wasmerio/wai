use heck::*;
use wasmer_wit_bindgen_gen_core::wit_parser::*;
...
/// ```
/// # use wasmer_wit_bindgen_gen_wasmtime_py::dependencies::Dependencies;
/// # use wasmer_wit_bindgen_gen_core::wit_parser::{Interface, Type};
/// # use wasmer_wit_bindgen_gen_wasmtime_py::source::Source;
